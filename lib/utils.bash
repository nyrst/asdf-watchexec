...
GH_REPO="https://github.com/watchexec/watchexec"
TOOL_NAME="watchexec"
TOOL_TEST="watchexec --version"
...
install_version() {
  ...
  local release_file="$install_path/$TOOL_NAME-$version.tar.xz"
  (
    ...
    # TODO: Asert watchexec executable exists.
    local tool_cmd
